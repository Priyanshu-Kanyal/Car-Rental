...
const socialLinks = [
    ...
    {
        url: "https://github.com/Priyanshu-Kanyal" ,
        icon: "ri-github-fill"
    },
    {
        url: "https://www.linkedin.com/in/priyanshu-kanyal-7808a7275/" ,
                        ...
                        <Col lg='5' md='5'>
                                <div className="contact__info">
                                    ...
                                    <p className="section__description mb-0">
                                        Mh-1 , Vit Ap University, Amaravati, Andhra Pradesh, India
                                    </p>

                                    <div className="d-flex align-items-center gap-2">
                                        <h6  className='mb-0 fs-6'>Phone :</h6>
                                        <p className="section__description mb-0">+91 7456893414</p>
                                    </div>

                                    <div className="d-flex align-items-center gap-2">
                                        <h6 className='mb-0 fs-6'>Email :</h6>
                                        <p className="section__description mb-0">kanyalpriyanshu1@gmail.com</p>
                                    </div>
